...
export function VinylCard() {
  return (
    <a href="/playlist" className="hidden lg:block absolute left-[40px] top-[530px] z-30 transition-all duration-300 -rotate-[5deg] hover:rotate-[2deg] hover:scale-110 hover:-translate-y-5 cursor-pointer group/vinyl hero-entrance" style={{ overflow: "visible", animation: "hero-slide-left 0.7s cubic-bezier(0.4,0,0.2,1) 2.5s both" }}>
      <div className="relative w-[240px]" style={{ overflow: "visible" }}>
        ...
        <div className="relative bg-white border border-editor-border rounded-2xl shadow-sm flex flex-col items-center w-[240px] pt-6 pb-6">
          ...
          <div className="relative z-[1] mt-4 text-center">
            ...
            <h3 className="font-[family-name:var(--font-noto)] text-text-primary font-bold text-lg leading-tight mb-1">Full Stack Vibes</h3>
            <p className="font-[family-name:var(--font-noto)] text-text-primary text-[11px] mb-1">9 tracks · built by Meet</p>
