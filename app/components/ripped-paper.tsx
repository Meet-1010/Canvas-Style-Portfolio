        ...
        >
          ...
          <div className="absolute inset-0">
            <div className="relative z-10 px-10 md:px-12 pt-[16%]">
              ...
              >
                I care about code that&rsquo;s clean, interfaces that feel right, and systems that hold together under pressure. Always in &ldquo;let me build this&rdquo; mode — curious, iterating, and shipping.
              </p>
            </div>
          </div>
        </div>
