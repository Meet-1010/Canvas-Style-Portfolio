...
export function MacFolder() {
  return (
    <div
      className="hidden lg:block absolute left-[430px] top-[430px] z-30 group cursor-pointer rotate-[6deg] transition-all duration-300 hover:scale-110 hover:-translate-y-2 hover:rotate-[2deg] hero-entrance"
...
export function CodeCard() {
  return (
    <motion.div
      className="hidden lg:block absolute right-[10px] top-[60px] z-20 hero-entrance"
      initial={{ opacity: 0, y: 30 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.7, delay: 2.8, ease: [0.4, 0, 0.2, 1] }}
      whileHover={{ scale: 1.04, rotate: -1, transition: { duration: 0.2 } }}
    >
      <div className="w-[280px] rounded-xl overflow-hidden" style={{
        background: "#1e1e2e",
        boxShadow: "0 8px 40px rgba(0,0,0,0.35), 0 2px 8px rgba(0,0,0,0.2)",
        border: "1px solid rgba(255,255,255,0.08)",
      }}>
        {/* Title bar */}
        <div className="flex items-center gap-[6px] px-4 py-[10px]" style={{ borderBottom: "1px solid rgba(255,255,255,0.07)", background: "#181825" }}>
          ...
          <span className="ml-3 font-mono text-[11px]" style={{ color: "rgba(255,255,255,0.35)" }}>portfolio.ts</span>
        </div>
        {/* Code */}
        <div className="px-4 py-4 font-mono text-[12px] leading-[1.75]" style={{ color: "#cdd6f4" }}>
          <div><span style={{ color: "#cba6f7" }}>const</span> <span style={{ color: "#89b4fa" }}>meet</span> <span style={{ color: "#89dceb" }}>=</span> <span style={{ color: "#cdd6f4" }}>{"{"}</span></div>
          <div className="pl-4"><span style={{ color: "#a6e3a1" }}>name</span><span style={{ color: "#cdd6f4" }}>:</span> <span style={{ color: "#f38ba8" }}>&quot;Meet Chauhan&quot;</span><span style={{ color: "#6c7086" }}>,</span></div>
          <div className="pl-4"><span style={{ color: "#a6e3a1" }}>role</span><span style={{ color: "#cdd6f4" }}>:</span> <span style={{ color: "#f38ba8" }}>&quot;Full Stack Dev&quot;</span><span style={{ color: "#6c7086" }}>,</span></div>
          <div className="pl-4"><span style={{ color: "#a6e3a1" }}>stack</span><span style={{ color: "#cdd6f4" }}>: [</span></div>
          <div className="pl-8"><span style={{ color: "#f38ba8" }}>&quot;React&quot;</span><span style={{ color: "#6c7086" }}>, </span><span style={{ color: "#f38ba8" }}>&quot;Node.js&quot;</span><span style={{ color: "#6c7086" }}>,</span></div>
          <div className="pl-8"><span style={{ color: "#f38ba8" }}>&quot;TypeScript&quot;</span><span style={{ color: "#6c7086" }}>, </span><span style={{ color: "#f38ba8" }}>&quot;MongoDB&quot;</span></div>
          <div className="pl-4"><span style={{ color: "#cdd6f4" }}>],</span></div>
          <div className="pl-4"><span style={{ color: "#a6e3a1" }}>openTo</span><span style={{ color: "#cdd6f4" }}>:</span> <span style={{ color: "#cba6f7" }}>true</span></div>
          <div><span style={{ color: "#cdd6f4" }}>{"}"}</span></div>
          <div className="mt-2 flex items-center gap-1"><span style={{ color: "#6c7086" }}>// </span><span className="inline-block w-[7px] h-[14px] ml-1 animate-pulse" style={{ background: "#cba6f7", borderRadius: 1 }} /></div>
        </div>
      </div>
    </motion.div>
  );
...
export function NameBadge() {
  return (
    <motion.div
      className="hidden lg:flex flex-col items-center absolute left-[65px] top-[-60px] z-20"
    ...
    >
     <a href="https://linkedin.com/in/meet-chauhan-5574a4264/" target="_blank" rel="noopener noreferrer" className="badge-swing flex flex-col items-center cursor-pointer group/badge">
      {/* Lanyard strap — extra tall to avoid gap when swinging */}
      <div className="w-[26px] h-[160px] bg-stone-800 relative shadow-sm z-0">
        ...
        <div className="rounded-lg overflow-hidden flex flex-col relative z-10" style={{
          ...
          <div className="relative px-4 pt-4 pb-4" style={{
            ...
            <div className="relative z-10">
              <h3 className="text-white font-extrabold text-[22px] leading-[1.05] tracking-[0.08em]">MEET CHAUHAN</h3>
              <p className="font-[family-name:var(--font-noto)] text-white/50 text-[11px] tracking-[0.05em] mt-2 leading-relaxed">Full Stack Developer<br />React · Node.js · TypeScript</p>
            </div>
            {/* Starburst accent */}
          ...
          <div className="px-4 pt-5 pb-5 flex flex-col items-center" style={{
            ...
            <div className="w-32 h-32 rounded-full overflow-hidden bg-stone-600 relative" style={{
              ...
              <video
                ...
                playsInline
                autoPlay
                className="absolute inset-0 w-full h-full opacity-0 group-hover/badge:opacity-100 transition-opacity duration-300"
